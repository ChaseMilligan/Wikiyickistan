...
Ingredients:
- Celestial Bone
	- Gain [temporary hit points](https://www.dndbeyond.com/compendium/rules/basic-rules/combat#TemporaryHitPoints) at the start of each minute, which increases with rarity.
	- 3d6
- Humanoid Heart
