...
Any @Adventurers who are interested, [join the campaign in D&D Beyond](https://www.dndbeyond.com/campaigns/join/79703081266549128), and respond in this thread if you would rather play in person or online. Either way, I am going to run the game in the official D&D Beyond Maps VTT. If you want to play in person make sure you have a laptop to bring.

---

# Character Creation

- Create a **Level 3** character.
- Any official species, class, or background is welcome.
- I have some suggestions for you to ignore below.
- Please roll stats before day of, otherwise use standard array.
- Your character should have a reason to take on dangerous work and cooperate with the rest of the party.
...
Characters proficient in **Arcana, Investigation, Nature, Perception, Religion, and/or Survival** will find opportunities to shine.

## Magic Items

Each character can choose **1 Uncommon**, and **1 Common** item from the lists below, as well as **1 zip of a novice strain of Arcannabis** from the list below. This is entirely optional. Potions count as your **1 Uncommon** item.
...
Do not use the homebrewed magic items in D&D Beyond labeled **"Arcannabis"**. They are deprecated, and don't fit the setting anymore.

- Grave Gaze #4 (Undead Eyes)
	...
	- **Radius:** 10 ft
- Wight Widow (Undead Blood)
	- The first time each turn that you hit an Undead creature, the attack deals bonus damage to the target of the same type as the attack.
- God's Green Crack (Celestial Bones)
	- Gain **1d6 temporary hit points** at the start of each minute.
- Death Bubba (Undead Fat)
	- Whenever you take necrotic damage, roll **1d4** and subtract the result from that damage.
- Hawkeye Haze (Beast Eyes)
	- Gain a **+1 bonus** to your Perception checks.
- Brainwreck (Aberration Brain)
	- Can communicate telepathically with creatures within **30 ft** of you. You must be able to see the creature and share a language to communicate in this way.
...
Before the session, think of **one regret or failure** from your character's past. It doesn't have to be tragic, just something your character wishes had gone differently. It may become important during the adventure.

---

If you're interested, let me know what you'd like to play!